...
// mak237, added torque mode disable for initialization in case of persistent changes
  torque_control_toggle(motor_id,0);

// mak237, added motor cw and ccw limit initialization
